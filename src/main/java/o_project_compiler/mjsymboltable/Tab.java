...
package o_project_compiler.mjsymboltable;
...
public class Tab extends rs.etf.pp1.symboltable.Tab {
    ...
    public static void dump(DumpSymbolTableVisitor mjSymbolTableVisitor, Logger logger) {
        if (mjSymbolTableVisitor == null) {
            mjSymbolTableVisitor = new DumpSymbolTableVisitor(true);
        }
